...
class Generator {
  ...
  */
	getCost() {
		...
		// BaseCost = 10
		// return Math.pow(1 + consants.growthRatio, this.quantity)
		return Math.round(this.baseCost * Math.pow(1 + _constants2.default.growthRatio, this.quantity) * 100) / 100;
	}
...
function main() {
	...
	if(window.myDefaultState != null){
		initialState = window.myDefaultState;
	}
...
exports.default = function (store) {
	return class GeneratorComponent extends window.HTMLElement {
		constructor() {
			...
			// subscribe to store on change event
			this.onStateChange = this.handleStateChange.bind(this);
			this.store.subscribe(this.onStateChange);
		}
